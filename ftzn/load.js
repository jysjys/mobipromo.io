$(function(){
    $('#header').load('./Header.html .header-container',function () {
        ...
        $.ajax({
            ...
            success: function(data) {
                $(".isLoginHead").html("<a id=\"userCenter\" href=\"./dist/index.html\">個人中心</a>")
                $(".isLoginRegisterHead").html("<p class=\"loginOut\">退出</p>")
            },
            error: function(data) {
                $(".isLoginHead").html("<a id=\"login\" href=\"./login.html\">登錄</a>")
                $(".isLoginRegisterHead").html("<a href=\"./register.html\">注冊</a>")
            }
        });
        ...
        $(".ft-language").siblings().find('a').css({color: '#333333'});
        $(".ft-language a").css({color: '#1890FF'})
